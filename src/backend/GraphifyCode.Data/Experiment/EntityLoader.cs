...
{
    private static readonly Loader<Service> ServicesLoader = new(
    ...
    private static readonly Loader<Endpoints> EndpointsLoader = new(
    ...
    private static readonly Loader<UseCase> UseCasesLoader = new(
    ...
    {
        [typeof(Service)] = ServicesLoader,
        [typeof(Endpoints)] = EndpointsLoader,
        [typeof(UseCase)] = UseCasesLoader
    };
